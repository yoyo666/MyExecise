    ...
    def __init__(self, x=None, kind=None, isred=None):
        ...
        if self.kind == 1:
            self.enemy_x_0 = pygame.image.load(
                r"E:\github\MyExecise\python\TankWar\image\enemy_1_0.png").convert_alpha()
            self.enemy_x_3 = pygame.image.load(
                r"E:\github\MyExecise\python\TankWar\image\enemy_1_3.png").convert_alpha()
        if self.kind == 2:
            self.enemy_x_0 = pygame.image.load(
                r"E:\github\MyExecise\python\TankWar\image\enemy_2_0.png").convert_alpha()
            self.enemy_x_3 = pygame.image.load(
                r"E:\github\MyExecise\python\TankWar\image\enemy_2_3.png").convert_alpha()
        if self.kind == 3:
            self.enemy_x_0 = pygame.image.load(
                r"E:\github\MyExecise\python\TankWar\image\enemy_3_1.png").convert_alpha()
            self.enemy_x_3 = pygame.image.load(
                r"E:\github\MyExecise\python\TankWar\image\enemy_3_0.png").convert_alpha()
        if self.kind == 4:
            self.enemy_x_0 = pygame.image.load(
                r"E:\github\MyExecise\python\TankWar\image\enemy_4_0.png").convert_alpha()
            self.enemy_x_3 = pygame.image.load(
                r"E:\github\MyExecise\python\TankWar\image\enemy_4_3.png").convert_alpha()
        self.enemy_3_0 = pygame.image.load(
            r"E:\github\MyExecise\python\TankWar\image\enemy_3_0.png").convert_alpha()
        self.enemy_3_2 = pygame.image.load(
            r"E:\github\MyExecise\python\TankWar\image\enemy_3_2.png").convert_alpha()
