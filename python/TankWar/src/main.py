...
def main():
    ...
    # 加载图片,音乐,音效.
    background_image     = pygame.image.load(r"E:\github\MyExecise\python\TankWar\image\background.png")
    home_image           = pygame.image.load(r"E:\github\MyExecise\python\TankWar\image\home.png")
    home_destroyed_image = pygame.image.load(r"E:\github\MyExecise\python\TankWar\image\home_destroyed.png")
    
    bang_sound          = pygame.mixer.Sound(r"E:\github\MyExecise\python\TankWar\music\bang.wav")
    bang_sound.set_volume(1)
    fire_sound           = pygame.mixer.Sound(r"E:\github\MyExecise\python\TankWar\music\Gunfire.wav")
    start_sound          = pygame.mixer.Sound(r"E:\github\MyExecise\python\TankWar\music\start.wav")
    start_sound.play()
    ...
    # 敌军坦克出现动画
    appearance_image = pygame.image.load(r"E:\github\MyExecise\python\TankWar\image\appear.png").convert_alpha()
    appearance = []
    ...
    while True:
        ...
        if key_pressed[pygame.K_m]:
            if not myTank_T2.bullet.life and myTank_T2.bulletNotCooling:
                fire_sound.play()
                myTank_T2.shoot()
                myTank_T2.bulletNotCooling = False
